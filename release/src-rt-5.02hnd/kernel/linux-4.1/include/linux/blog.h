...
struct blog_t {
    ...
    union {
        ...
        struct {
            uint16_t    unused     : 12;
            uint16_t    l2_pppoe   :  1; /* L2 packet is PPPoE */
            uint16_t    l2_ipv6    :  1; /* L2 packet is IPv6  */
            uint16_t    l2_ipv4    :  1; /* L2 packet is IPv4  */
...
typedef void (* BlogFaHook_t)(void *ct_p, int is_downstream, BlogFlowEventType_t type);

typedef void (* BlogFdHook_t)(void *ct_p, int is_downstream, BlogFlowEventType_t type);
