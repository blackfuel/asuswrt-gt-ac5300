...
Public	void
BlockLongSubtract (int size, long* src1Ptr, long* src2Ptr, long* dstPtr)
	/****************************************************************************/
	/*	This function perfoms block suburaction of two short type arrays		*/	
	/****************************************************************************/
	{
	long	*srcEndPtr = src1Ptr + size;
...
Public	void
BlockShort2LongMove (int size, short* srcPtr, long* dstPtr)
	/****************************************************************************/
	/*	This function perfoms block suburaction of two short type arrays		*/	
	/****************************************************************************/
	{
...
BlockShortScale (int size, short scaleFactor, int shift, short* srcPtr, short* dstPtr)
	...
	do
		{
		*dstPtr++ = ( ((long)*srcPtr++) * (long)scaleFactor) >> shift;
		} while (srcPtr != srcEndPtr);
	}
#endif
...
#if defined(ADSLDRV_LITTLE_ENDIAN) && (defined(__arm) || defined(CONFIG_ARM))
Public	int BlockShortMoveReverse(int size, short* srcPtr, short* dstPtr)
	/****************************************************************************/
	/*	This function perfoms block move of a short type data					*/	
	/****************************************************************************/
{
	...
	/****************************************************************************/
{
	...
	/*ASSERT(((ulong)srcPtr & 1)==0);*/ /* C6x */
	/*ASSERT(((ulong)dstPtr & 1)==0);*/ /* C6x */
	ASSERT(size > 0);
	if(size > 0) {
...
Public	void
BlockLongClear (int size, long* dstPtr)
	/****************************************************************************/
	/*	This function fills a block with a constant								*/	
	/****************************************************************************/
	{
...
Public	void
BlockComplexLongFill(int size, long xFill, long yFill, ComplexLong *dstPtr)
	{
...
#if defined(ADSLDRV_LITTLE_ENDIAN) && (defined(__arm) || defined(CONFIG_ARM))
Public	void
BlockLongMoveReverse (int size, long* srcPtr, long* dstPtr)
	/****************************************************************************/
	/*	This function perfoms block move of a long type data					*/	
	/****************************************************************************/
{
...
BlockShortInterpolate (int size, short scaleFactor, int shift, short* src1Ptr, short* src2Ptr, short* dstPtr)
	...
	do
		{
		*dstPtr = *src1Ptr + (((long)(*src2Ptr - *src1Ptr) * scaleFactor) >> shift);
		src1Ptr++;
		src2Ptr++;
		dstPtr++;
...
BlockReal2ComplexMult	(int size,
	...
	do
		{
		dstPtr->x = ((long)(*src1Ptr) * (long)(src2Ptr->x)) >> 14;
		dstPtr->y = ((long)(*src1Ptr) * (long)(src2Ptr->y)) >> 14;
		src1Ptr++;
		src2Ptr++;
		dstPtr++;
		} while (src1Ptr != src1EndPtr);
...
BlockComplexMultLongAcc	(int size,
	...
	do
		{
		dstPtr->x += ( (long)(src1Ptr->x) * (long)(src2Ptr->x) -
		               (long)(src1Ptr->y) * (long)(src2Ptr->y) ) >> shift;
		dstPtr->y += ( (long)(src1Ptr->x) * (long)(src2Ptr->y) +
		               (long)(src1Ptr->y) * (long)(src2Ptr->x) ) >> shift;
...
BlockComplexMult	(int size,
	...
	do
		{
		shortComplexTemp.x = (	(long)(src1Ptr->x) * (long)(src2Ptr->x)
		             		  -	(long)(src1Ptr->y) * (long)(src2Ptr->y) ) >> 14;
		shortComplexTemp.y = (	(long)(src1Ptr->x) * (long)(src2Ptr->y)
		             		  +	(long)(src1Ptr->y) * (long)(src2Ptr->x) ) >> 14;
...
BlockComplexConjigateMult	(int size,
	...
	do
		...
		shortComplexTemp.x = (	(long)(src1Ptr->x) * (long)(src2Ptr->x)
		             		  +	(long)(src1Ptr->y) * (long)(src2Ptr->y) ) >> 14;
		shortComplexTemp.y = (	(long)(src1Ptr->y) * (long)(src2Ptr->x)
		             		  -	(long)(src1Ptr->x) * (long)(src2Ptr->y) ) >> 14;
		*dstPtr = shortComplexTemp;
		src1Ptr++;
		src2Ptr++;
		dstPtr++;
...
BlockReal2ComplexMacc	(int size,
	...
	do
		{
		sum.x += ((long)(*src1Ptr) * (long)(src2Ptr->x));
		sum.y += ((long)(*src1Ptr) * (long)(src2Ptr->y));
		src1Ptr++;
		src2Ptr++;
		} while (src1Ptr != src1EndPtr);
...
BlockPower (int size, short* srcPtr)
	...
	do
		{
		power1 = VLAddLong(power1, (long)srcPtr[0] * (long)srcPtr[0]);
#ifdef BLOCKPOWER_40BIT_SINGLE_ACCUMULATOR
		power1 = VLAddLong(power1, (long)srcPtr[1] * (long)srcPtr[1]);
#else
		power2 = VLAddLong(power2, (long)srcPtr[1] * (long)srcPtr[1]);
#endif
		srcPtr += 2;
...
BlockPower (int size, short* srcPtr)
	...
	do
		{
		power += ((long)(*srcPtr) >> 2) * ((long)(*srcPtr) >> 2);
...
BlockCorrelate (int size, short* src1Ptr, short* src2Ptr)
	...
	do
		{
		correlation += ((long)(*(src1Ptr + 0)) >> 2) * ((long)(*(src2Ptr + 0)) >> 2);
		correlation += ((long)(*(src1Ptr + 1)) >> 2) * ((long)(*(src2Ptr + 1)) >> 2);
		src1Ptr += 2;
		src2Ptr += 2;
		} while (src1Ptr != src1EndPtr);
 ...
 ******************************************************************************/
	...
	do
		...
		do
			{
			tempX = ( (
				(long)(scalePtr->x) * (long)(srcPtr->x) -
				(long)(scalePtr->y) * (long)(srcPtr->y) + rnd) >> scaleShift);
			tempY = ( (
				(long)(scalePtr->x) * (long)(srcPtr->y) +
				(long)(scalePtr->y) * (long)(srcPtr->x) + rnd) >> scaleShift);

/* This overflow may produce unpredictable results depending on */
/* different C compilers and hardware platforms */

			WARN( tempX == (long)((short)tempX) );
			WARN( tempY == (long)((short)tempY) );
 ...
 ******************************************************************************/
	...
	do
		...
		do
			...
			tempX = (((long)(*scalePtr) * (long)(srcPtr->x)) >> scaleShift);
			tempY = (((long)(*scalePtr) * (long)(srcPtr->y)) >> scaleShift);
 ...
 ****************************************************************************/
	...
	do
		...
		do
			{
			cx  += (long)(bp1->x) * (long)(bp2->x)
			     + (long)(bp1->y) * (long)(bp2->y);
			cy  += (long)(bp1->x) * (long)(bp2->y)
			     - (long)(bp1->y) * (long)(bp2->x);
			bp1 += symSize;
			bp2 += symSize;
			} while (bp2 != bp3);
		...
		if(gainShift1 >= 0)
			{
			cx += (long)((ulong)coefLowPtr->x << gainShift1);
			cy += (long)((ulong)coefLowPtr->y << gainShift1);
...
BlockCplxLongConjigateMultCplxShort	(int size,
	...
	long		tempX0, tempX1, tempY0, tempY1, temp0, temp1;
	...
	do
		...
		temp0 = tempX0 * (long)(src2Ptr->x) + tempY0 * (long)(src2Ptr->y);
		temp1 = tempX1 * (long)(src2Ptr->x) + tempY1 * (long)(src2Ptr->y);
		dstPtr->x = (temp0 >> 12) + (temp1 << 3);
		
		temp0 = tempY0 * (long)(src2Ptr->x) - tempX0 * (long)(src2Ptr->y);
		temp1 = tempY1 * (long)(src2Ptr->x) - tempX1 * (long)(src2Ptr->y);
