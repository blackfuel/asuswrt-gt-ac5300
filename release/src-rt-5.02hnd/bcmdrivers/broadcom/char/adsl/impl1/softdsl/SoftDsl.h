...
#define kDslBitswapControlCmd       (kFirstDslCommandCode + 58)
    ...
    #define kDslGfastTestRPA            64
    #define kDslGfastTestSRA_RPA        65
    #define kDslGfastTestFRA            66
    ...
    #define kDslGfastTestRPANack        164
    #define kDslGfastTestFRANack        165
    /* End of GFAST specific commands */
...
#define kDslInterop2GfastPreInteropPhase1   0x00000080
...
typedef struct
        {
        ulong                           cntVecFBSegmentSend;
        ulong                           cntVecFBSegmentDrop;
        ulong                           cntVecFBMessageSend;
        ulong                           cntVecFBMessageDrop;
...
#define kPhyCfg2DisableRefErrSample		  	   0x00200000  /* To disable reference error sample generation  */
#define kPhyCfg2EnableGfastV43ToneSet          0x00400000  /* enable V43 tone set for GFAST */
/* Please use 0x00080000 in cfg2 for the next driver bit and remove this comment */
...
#define	DSL_MIPSCORE_ID(x)		((uchar)(((ulong)(x) & DSL_MIPSCORE_MASK) >> DSL_MIPSCORE_SHIFT))
