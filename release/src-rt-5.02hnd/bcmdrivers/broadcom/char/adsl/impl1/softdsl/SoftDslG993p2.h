...
#define AFE_CHIP_GFAST      6     /* for G.fast: CH0 Tx + CH0 Rx + CH2 Rx */
#define AFE_CHIP_RNC        7     /* for RNC: CH2 Rx */
#define AFE_CHIP_GFCH0      7     /* for G.fast/VDSL combo */
#define AFE_CHIP_MAX				AFE_CHIP_GFCH0
...
#define AFE_FE_REV_6303_REV_12_50 1         // 63138 AFE for g.fast
/* RNC configurations */
...
#define AFE_FE_REV_6303_REV_12_50_BITMAP	(AFE_FE_REV_6303_REV_12_50 << AFE_FE_REV_SHIFT)
...
#define AFE_FE_COMB_X_12_50		    (AFE_LD_6303_BITMAP | AFE_CHIP_GFAST_BITMAP | AFE_FE_ANNEXX_BITMAP | AFE_FE_AVMODE_COMBO_BITMAP | AFE_FE_REV_6303_REV_12_50_BITMAP)
...
#define AFECTL1_LAST_MODE_VDSL              0x2
...
struct ntrCntStruct {
    ulong   ncoOutCntAtDmt;
    ulong   ncoOutCntAtNtr;
    ulong   lcoCntAtDmt;
    ulong   lcoCntAtNtr;
    ulong   ncoRefCntAtDmt;
    ulong   ncoRefCntAtNtr;
    /* 6362/63268 */
#if defined(CONFIG_BCM96362) || defined(CONFIG_BCM96328) || defined(CONFIG_BCM963268) || defined(CONFIG_BCM96318) ||\
    defined(CONFIG_BCM963138) || defined(CONFIG_BCM963381) || defined(CONFIG_BCM963148)
    long    phaseError;
    long    VCOAdjInfo;
#endif
};
