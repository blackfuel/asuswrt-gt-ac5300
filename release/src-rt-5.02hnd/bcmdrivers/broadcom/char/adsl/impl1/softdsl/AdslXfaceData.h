...
typedef struct _DslParamData {
	unsigned short      len;    /* length of the structure */
	unsigned char       verId;  /* version ID */
	unsigned char       ctrl;   /* reserved */
	unsigned long       lowSdramSize;    /* required size of low (below 16MB SDRAM) */
} DslParamData;
