...
void DiagWriteStatusInfo(unsigned long cmd, char *p, int n, char *p1, int n1)
{
}
...
void DiagWriteFile(unsigned long lineId, unsigned long clientType, char *fname, void *ptr, unsigned long len)
{
}

void __DiagStrPrintf(unsigned long lineId, unsigned long clientType, const char *fmt, int fmtLen, int argNum, ...)
{
}
...
int BcmCoreDiagLogActive(unsigned long map)
{
	return 0;
}
