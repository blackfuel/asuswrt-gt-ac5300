...
#endif
#elif defined(CONFIG_BCM_DSL_GFAST) /* !SUPPORT_MULTI_PHY */
#define	PHY_SWITCH_SHIFT		0
#define	PHY_SWITCH_MSK			(1 << PHY_SWITCH_SHIFT)
#define	PHY_SWITCH_DISABLED		(1 << PHY_SWITCH_SHIFT)
#define	PHY_TYPE_SHIFT			1
#define	PHY_TYPE_MSK			(1 << PHY_TYPE_SHIFT)
#define	PHY_TYPE_NON_GFAST		(0 << PHY_TYPE_SHIFT)
#define	PHY_TYPE_GFAST			(1 << PHY_TYPE_SHIFT)
#if 0
