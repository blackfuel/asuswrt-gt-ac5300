...
#endif
void BcmAdslCoreDiagStartLog_1(unsigned char lineId, unsigned long map, unsigned long time);
void BcmAdslCoreDiagStartLog_2(unsigned char lineId, unsigned long map, unsigned long time);
