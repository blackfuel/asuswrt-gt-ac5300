...
// functions not currently needed
...
MpcpGateGrantInfo* MpcpGateGrant (const MpcpGateMsg* msg, U8 grant)
    {
    return (MpcpGateGrantInfo*)(msg + 1) + grant;
    } // MpcpGateGrant
...
MpcpGateDiscoveryInfo1G* MpcpGateDiscovery1G (const MpcpGateMsg* msg)
    {
    return (MpcpGateDiscoveryInfo1G*)
        ((MpcpGateGrantInfo*)(msg + 1) +
                (msg->flags & MpcpGateFlagNumGrantsMsk));
    } // MpcpGateDiscovery1G


////////////////////////////////////////////////////////////////////////////////
/// MpcpGateDiscovery10G:  locates discovery information in a 10G gate message
///
/// The caller should ensure that the message is actually a discovery gate
/// (msg->flags & Discovery)
/// \param m    Message containing discovery info
...
MpcpGateDiscoveryInfo10G* MpcpGateDiscovery10G (const MpcpGateMsg* msg)
    {
    return (MpcpGateDiscoveryInfo10G*)MpcpGateDiscovery1G(msg);
    } // MpcpGateDiscovery10G
