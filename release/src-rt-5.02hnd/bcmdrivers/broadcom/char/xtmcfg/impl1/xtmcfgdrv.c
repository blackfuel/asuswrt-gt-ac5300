...
static void DoGetBondingInfo( unsigned long arg );
static void DoSetDsPtmBondingDeviation ( unsigned long arg );
static void DoGetErrorStatistics( unsigned long arg );
...
void *g_pfnExtBondingCommSetInterfaceLinkInfo = NULL;
    ...
    unsigned int command, unsigned long arg )
{
    ...
    FN_IOCTL IoctlFuncs[] = {DoInitialize, DoUninitialize,
        ...
        DoCreateNetworkDevice, DoDeleteNetworkDevice, DoReInitialize, DoGetBondingInfo, 
        DoSetDsPtmBondingDeviation, NULL, DoGetErrorStatistics};
...
static void DoReInitialize( unsigned long arg )
{
    BCMXTM_STATUS bxStatus = BcmXtm_ReInitialize();
    put_user( bxStatus, &((PXTMCFGDRV_STATUS_ONLY) arg)->bxStatus );
} /* DoReInitialize */
...
/***************************************************************************
 * Function Name: DoSetDsPtmBondingDeviation
 * Description  : Calls BcmXtm_SetDsPtmBondingDeviation on behalf of a user program.
 * Returns      : None.
 ***************************************************************************/
static void DoSetDsPtmBondingDeviation ( unsigned long arg )
{
    XTMCFGDRV_PTMBONDINGCFG KArg;

    if( copy_from_user( &KArg, (void *) arg, sizeof(KArg) ) == 0 )
    {
        KArg.bxStatus = BcmXtm_SetDsPtmBondingDeviation ( KArg.ulDeviation ) ;
        put_user( KArg.bxStatus,
            &((PXTMCFGDRV_PTMBONDINGCFG) arg)->bxStatus );
    }
} /* DoSetDsPtmBondingDeviation */
...
EXPORT_SYMBOL(BcmXtm_SetDsPtmBondingDeviation);
...
EXPORT_SYMBOL(g_pfnExtBondingCommSetInterfaceLinkInfo) ;
