...
*/
/***************************************************************************
 * File Name  : xtmcfgmain.cpp (impl1)
 *
...
typedef void (*FN_EXT_BONDING_COMM_SetInterfaceLinkInfo) (UINT32 ulPortId, 
		                                                    PXTM_INTERFACE_LINK_INFO pLinkInfo) ;

extern "C" {

extern FN_EXT_BONDING_COMM_SetInterfaceLinkInfo g_pfnExtBondingCommSetInterfaceLinkInfo ;
}
    ...
    PXTM_INTERFACE_LINK_INFO pLinkInfo )
{
    ...
    if( g_pXtmProcessor )
    {
        if (g_pfnExtBondingCommSetInterfaceLinkInfo != NULL) {
	    		g_pfnExtBondingCommSetInterfaceLinkInfo (ulPortId, pLinkInfo) ;
				XtmOsDelay (200) ;
		  }
...
/***************************************************************************
 * Function Name: BcmXtm_SetDsPtmBondingDeviation
 * Description  : 
 * Returns      : XTMSTS_SUCCESS if successful or error status.
 ***************************************************************************/
extern "C"
...
{
    return( (g_pXtmProcessor)
        ? g_pXtmProcessor->SetDsPtmBondingDeviation ( ulDeviation )
        : XTMSTS_STATE_ERROR );
} /* BcmXtm_SetDsPtmBondingDeviation */
