 ...
 ***************************************************************************/
int XTM_AUTOSENSE::LineActive(unsigned long ulPhysPort) {
 ...
 * Returns      : Result of transition (XTMSTS_SUCCESS on success)
 ***************************************************************************/
int XTM_AUTOSENSE::LineIdle(unsigned long ulPhysPort) {
...
int XTM_AUTOSENSE::Transition(XtmAutoSenseTransition eTransition) {
   ...
   unsigned long ulCurrTimestampMs;  // Current time for timeouts
