...
int XTM_OAM_HANDLER::TimerUpdate( void )
{
   /* For the 63138 and 63148, implement a workaround to strip bytes and
    ...
    unsigned long ulCurrTimestampUs;  // Current time for timeouts
   ...
   {
       static long lSavedOamRxCount = 0; /* Last received total number of OAMs */
       static long lSavedOamTxCount = 0; /* Last transmitted total number of OAMs */
       long lCurrOamRxCount = 0;         /* Current received total number of OAMs */
       long lCurrOamTxCount = 0;         /* Current transmitted total number of OAMs */
       int i;
