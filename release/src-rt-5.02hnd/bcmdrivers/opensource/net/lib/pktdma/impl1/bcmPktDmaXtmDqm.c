                                       ...
                                       int dropProbabilityHi, int minThresholdHi, int maxThresholdHi)
{
    ...
    if (dropAlgorithm == WA_WRED)
    {
        ...
        faptmMinThreshLo = (minThresholdLo * QUEUE_DROP_THRESHOLD) / 100;
        faptmMaxThreshLo = (maxThresholdLo * QUEUE_DROP_THRESHOLD) / 100;
        faptmDropProbHi = dropProbabilityHi;
        faptmMinThreshHi = (minThresholdHi * QUEUE_DROP_THRESHOLD) / 100;
        faptmMaxThreshHi = (maxThresholdHi * QUEUE_DROP_THRESHOLD) / 100;
    }
