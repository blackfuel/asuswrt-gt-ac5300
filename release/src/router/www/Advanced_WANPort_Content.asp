													...
													$('#ad_radio_dualwan_enable').iphoneSwitch(wans_dualwan_array[1] != 'none',
														 ...
														 function() {
														 	if(wans_dualwan_array[0] != "wan"){
														 		var confirm_str = "The current primary wan is \""+wans_dualwan_array[0].toUpperCase()+"\". Disable dual wan will change primary wan to \"Ethernet WAN\", are you sure to do it?"; //untranslated
															 	if(!confirm(confirm_str)){
															 		curState = "1";
