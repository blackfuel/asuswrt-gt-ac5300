...
.alexa_icon{
	background:url('images/New_ui/icon_alexa.jpg') no-repeat;
	height:140px;
	width:262px;
	background-size: 48%;
	margin: 62px 0px 0px 74px;
}
</style>
<script>
...
<input type="hidden" name="current_page" value="Advanced_Smart_Control_Alexa.asp">
<input type="hidden" name="next_page" value="Advanced_Smart_Control_Alexa.asp">
											...
											<div class="div_tr">
												<div class="div_td div_desc" style="width:55%">
													...
													<div style="padding-left:20px;font-style:Arial, Helvetica, sans-serif;font-size:13px;">
														Connect ASUS router to your Amazon Alexa and enjoy control your router via speaking. Please 
														<a style="font-weight: bolder;text-decoration: underline;color:#FFCC00" href="http://alexa.amazon.com/spa/index.html#skills/beta/amzn1.ask.skill.ea91f4d4-81a2-463a-bbba-8ac4b4506401/?ref=skill_dsk_skb_ys_0" target="_blank">Login</a>
														 your Alexa account first and click "GO" to set your Alexa skills with ASUS router!
													</div>
													<div class="apply_gen" style="padding-top:20px">
														<a href="javascript:" onclick="window.open('http://alexa.amazon.com/spa/index.html#skills/beta/amzn1.ask.skill.ea91f4d4-81a2-463a-bbba-8ac4b4506401/?ref=skill_dsk_skb_ys_0');" target="_blank">
															<input name="button" type="button" class="button_gen_short" value="GO">
														</a>
													</div>
												</div>
												<div class="div_td">
													<div class="alexa_icon"></div>
												</div>
											</div>
											<div class="div_tr">
