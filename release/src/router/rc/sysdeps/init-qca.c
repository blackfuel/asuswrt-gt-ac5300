...
void config_switch(void)
{
	...
	case MODEL_HIVEDOT:	/* fall through */
	case MODEL_HIVESPOT:	/* fall through */
...
{
	char *wif[] = { WIF_2G, WIF_5G, WIF_5G2 };
...
{
	char *sta[] = { STA_2G, STA_5G, STA_5G2 };
...
{
	char *vphy[] = { VPHY_2G, VPHY_5G, VPHY_5G2 };
